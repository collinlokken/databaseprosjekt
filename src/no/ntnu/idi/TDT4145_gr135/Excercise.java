...
public class Excercise {
	...
	private Excercise(int excerciseID, int date, int time, int length, String info, int performance, int personalShape) {
	...
	public ResultSet insertExcerciseIntoDB(int excerciseID, int date, int time, int length, String info, int performance, int personalShape, Connection conn) {
		
				
		
	}
	
	public ResultSet retrieveExcerciseFromDB(Connection conn) {
		try {	
